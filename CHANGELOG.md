...
- Upgrade infrastructure-bundle to 3.2.0
  - See https://github.com/newrelic/infrastructure-bundle/releases/tag/v3.2.0 for more details about the upgraded integrations in this release of the infrastructure-bundle

## 2.13.7

### Added

- Upgrade infrastructure-bundle to 3.1.8
  - See https://github.com/newrelic/infrastructure-bundle/releases/tag/3.1.8 for more details about the upgraded integrations in this release of the infrastructure-bundle

## 2.13.6

### Added

- Upgrade infrastructure-bundle to 3.1.4
  - See https://github.com/newrelic/infrastructure-bundle/releases/tag/3.1.4 for more details about the upgraded integrations in this release of the infrastructure-bundle
...
### Added
- Upgrade infrastructure-bundle to 2.8.32
    - See https://github.com/newrelic/infrastructure-bundle/releases/tag/2.8.32 for more details about the upgraded integrations in this release of the infrastructure-bundle
- Updated dependencies

## 2.13.3

### Added
- Upgrade infrastructure-bundle to 2.8.28
    - See https://github.com/newrelic/infrastructure-bundle/releases/tag/2.8.28 for more details about the upgraded integrations in this release of the infrastructure-bundle
- Updated dependencies

## 2.13.2

### Added
- Upgrade infrastructure-bundle to 2.8.25
    - See https://github.com/newrelic/infrastructure-bundle/releases/tag/2.8.25 for more details about the upgraded integrations in this release of the infrastructure-bundle
- Updated dependencies
...
### Added
- Upgrade infrastructure-bundle to 2.8.15
    - See https://github.com/newrelic/infrastructure-bundle/releases/tag/2.8.15 for more details about the upgraded integrations in this release of the infrastructure-bundle
...
### Added
- Upgrade infrastructure-bundle to 2.8.11
    - See https://github.com/newrelic/infrastructure-bundle/releases/tag/2.8.11 for more details about the upgraded integrations in this release of the infrastructure-bundle
...
### Added
- Upgrade infrastructure-bundle to 2.8.10
    - See https://github.com/newrelic/infrastructure-bundle/releases/tag/2.8.10 for more details about the upgraded integrations in this release of the infrastructure-bundle
