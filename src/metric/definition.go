...
var KSMSpecs = definition.SpecGroups{
	"persistentvolume": {
		...
		Specs: []definition.Spec{
			...
			{Name: "persistentVolumeName", ValueFunc: prometheus.FromLabelValue("kube_persistentvolume_info", "persistentvolume"), Type: sdkMetric.ATTRIBUTE},
			{Name: "persistentVolumeClaimName", ValueFunc: prometheus.FromLabelValue("kube_persistentvolume_claim_ref", "name"), Type: sdkMetric.ATTRIBUTE},
			{Name: "persistentVolumeClaimNamespace", ValueFunc: prometheus.FromLabelValue("kube_persistentvolume_claim_ref", "claim_namespace"), Type: sdkMetric.ATTRIBUTE},
