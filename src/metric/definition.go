...
var KSMSpecs = definition.SpecGroups{
	...
	"job_name": {
		...
		Specs: []definition.Spec{
			...
			{Name: "parallelism", ValueFunc: prometheus.FromValue("kube_job_spec_parallelism"), Type: sdkMetric.GAUGE},
			{Name: "completions", ValueFunc: prometheus.FromValue("kube_job_spec_completions"), Type: sdkMetric.GAUGE},
			{Name: "activeDeadlineSeconds", ValueFunc: prometheus.FromValue("kube_job_spec_active_deadline_seconds"), Type: sdkMetric.GAUGE, Optional: true},
