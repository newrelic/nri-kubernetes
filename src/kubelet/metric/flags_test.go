...
func TestCalculateFlagsFingerprint(t *testing.T) {
	...
	fp1 := fetcher.calculateFlagsFingerprint(flags1)
	fp2 := fetcher.calculateFlagsFingerprint(flags2)
	fp3 := fetcher.calculateFlagsFingerprint(flags3)
...
func TestFlagsToRawMetrics_EmptyFlags(t *testing.T) {
	...
	metrics := fetcher.flagsToRawMetrics(flags)
